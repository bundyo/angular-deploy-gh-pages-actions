...
| -------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------- | -------- | -------- |
| `project_name`          | The angular project that we want to deploy. This is needed when you have several projects within your angular.json. Defaults to "defaultProject" in angular.json.                                                                                                                                                            | `with`           | **No**  |  "defaultProject" in angular.json  |
...
| `skip_npm_install`          | Skip the initial npm install - useful when you want to run it separately.                                                                                                                                                            | `with`           | **No**  | false |
